...
final class LiquidgumboManiphestCustomFieldDuplicates extends ManiphestCustomField implements PhabricatorStandardCustomFieldInterface
{
    ...
    {
        return 'liquidgumbo:maniphest:duplicates';
    }

    public function getInverseFieldKey()
    {
        return id(new LiquidgumboManiphestCustomFieldDuplicatedBy())->getFieldKey();
    }
    ...
    {
        return pht('Duplicates');
    }

    public function getFieldDescription()
    {
        return 'This tasks duplicates tasks a,b,c etc.';
    }
    ...
    public function applyExternalTransactionEffect(PhabricatorApplicationTransaction $xaction)
    {
        ...
        $transaction->setFieldId(id(new LiquidgumboManiphestCustomFieldDuplicatedBy())->getFieldKey());
