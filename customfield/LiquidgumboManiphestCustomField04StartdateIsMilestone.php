...
final class LiquidgumboManiphestCustomFieldStartdateIsMilestone extends ManiphestCustomField implements PhabricatorStandardCustomFieldInterface
{
    ...
    {
        return 'liquidgumbo:maniphest:startdateIsMilestone';
    }
    ...
    {
        return pht('Startdate is milestone');
    }

    public function getFieldDescription()
    {
        return 'Is the startdate a milestone';
    }
