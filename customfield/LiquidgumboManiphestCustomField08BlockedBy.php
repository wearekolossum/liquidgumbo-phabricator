...
final class LiquidgumboManiphestCustomFieldBlockedBy extends ManiphestCustomField implements PhabricatorStandardCustomFieldInterface
{
    ...
    {
        return 'liquidgumbo:maniphest:blockedBy';
    }

    public function getInverseFieldKey()
    {
        return id(new LiquidgumboManiphestCustomFieldBlocks())->getFieldKey();
    }
    ...
    {
        return pht('Blocked by');
    }

    public function getFieldDescription()
    {
        return 'This tasks start is blocked by the completion of tasks a,b,c etc.';
    }
    ...
    public function applyExternalTransactionEffect(PhabricatorApplicationTransaction $xaction)
    {
        ...
        $transaction->setFieldId(id(new LiquidgumboManiphestCustomFieldBlocks())->getFieldKey());
