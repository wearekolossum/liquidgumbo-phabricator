...
final class LiquidgumboManiphestCustomFieldClones extends ManiphestCustomField implements PhabricatorStandardCustomFieldInterface
{
    ...
    {
        return 'liquidgumbo:maniphest:clones';
    }

    public function getInverseFieldKey()
    {
        return id(new LiquidgumboManiphestCustomFieldClonedBy())->getFieldKey();
    }
    ...
    {
        return 'This tasks clones tasks a,b,c etc.';
    }
    ...
    public function applyExternalTransactionEffect(PhabricatorApplicationTransaction $xaction)
    {
        ...
        $transaction->setFieldId(id(new LiquidgumboManiphestCustomFieldClonedBy())->getFieldKey());
